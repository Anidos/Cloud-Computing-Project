...
'''
def openfileEnc():
	filename = tkinter.filedialog.askopenfilename(initialdir = "C://Users//anidoshi//Downloads",title = "Select file",filetypes = (("text files","*.txt"),("all files","*.*")))
	fileToEncrptyEntryUpdate(filename)

def opendirectoryEnc():
	directory = tkinter.filedialog.askdirectory(initialdir = "C://Users//anidoshi//Downloads",title = "Select directory")
